...
REM x264_32_tMod-8bit-all.exe --level 3.1 --crf 24 --min-keyint 23 --bframes 5 --b-pyramid strict --ref 5 --qpmax 49 --vbv-bufsize 17500 --vbv-maxrate 17500 --cqm "jvt" --keyint 500 --me umh --subme 12 --aq-strength 1.0 --aq-mode 4 --fade-compensate 0.40 --merange 32 --direct auto --device psv+dxva --threads 18 --output "%ANIME_NAME_PREFIX%.264" "{{avsfile}}"
REM x264_32_tMod-8bit-all.exe --crf 24 --rc-lookahead 80 --merange 24 --min-keyint 1 --cqm "jvt" --keyint 500 --me umh --subme 9 --device psv+dxva --threads 18 --output "%ANIME_NAME_PREFIX%.264" "{{avsfile}}"
